 ...
 */
    ...
    if (preg_match("/(MantanoReader|FBReader|Stanza|Marvin|Aldiko|Moon\+ Reader|Chunky|AlReader|org\.ebookdroid|BookReader|CoolReader|PageTurner)/", $_SERVER['HTTP_USER_AGENT'])) {
