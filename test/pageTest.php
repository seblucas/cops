...
class PageTest extends PHPUnit_Framework_TestCase
{
    public function testPageIndex ()
    {
        ...
        $this->assertEquals ("Publication year", $currentPage->entryArray [3]->title);
        $this->assertEquals (5, $currentPage->entryArray [3]->numberOfElement);
        $this->assertEquals ("Tags", $currentPage->entryArray [4]->title);
        $this->assertEquals ("Alphabetical index of the 11 tags", $currentPage->entryArray [4]->content);
        $this->assertEquals (11, $currentPage->entryArray [4]->numberOfElement);
        $this->assertEquals ("Ratings", $currentPage->entryArray [5]->title);
        $this->assertEquals ("3 ratings", $currentPage->entryArray [5]->content);
        $this->assertEquals (3, $currentPage->entryArray [5]->numberOfElement);
        $this->assertEquals ("Languages", $currentPage->entryArray [6]->title);
        $this->assertEquals ("Alphabetical index of the 2 languages", $currentPage->entryArray [6]->content);
        $this->assertEquals (2, $currentPage->entryArray [6]->numberOfElement);
        $this->assertEquals ("All books", $currentPage->entryArray [7]->title);
        $this->assertEquals ("Alphabetical index of the 15 books", $currentPage->entryArray [7]->content);
        ...
        $this->assertEquals ("50 most recent books", $currentPage->entryArray [8]->content);
        $this->assertEquals (50, $currentPage->entryArray [8]->numberOfElement);
    ...
    public function testPageIndexWithIgnored ()
    {
        ...
        $config ['cops_ignored_categories'] = array ("author", "series", "tag", "publisher", "language", "publishdate");
    ...
    public function testPageIndexWithCustomColumn_Type1 ()
    {
        ...
        $this->assertEquals ("Type1", $currentPage->entryArray [7]->title);
        $this->assertEquals ("Custom column 'Type1'", $currentPage->entryArray [7]->content);
        $this->assertEquals (2, $currentPage->entryArray [7]->numberOfElement);
    ...
    public function testPageIndexWithCustomColumn_Type2 ()
    {
        ...
        $this->assertCount (10, $currentPage->entryArray);
        $this->assertEquals ("Type2", $currentPage->entryArray [7]->title);
        $this->assertEquals ("Custom column 'Type2'", $currentPage->entryArray [7]->content);
        $this->assertEquals (3, $currentPage->entryArray [7]->numberOfElement);
    ...
    public function testPageIndexWithCustomColumn_Type4 ()
    {
        ...
        $this->assertEquals ("Alphabetical index of the 2 series", $currentPage->entryArray [7]->content);
        $this->assertEquals (2, $currentPage->entryArray [7]->numberOfElement);
